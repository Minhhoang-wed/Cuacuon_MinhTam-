...
export async function saveSeoSettings(form: FormData) {
  ...
  const fields = [
    "seo_title_template", "seo_site_name", "seo_default_description",
    "seo_keywords", "seo_canonical_base",
    "og_title", "og_description", "og_image_url", "og_locale",
    "twitter_card", "twitter_title", "twitter_description", "twitter_image_url", "twitter_site",
    "robots_index", "robots_follow",
    "structured_business_name", "structured_phone", "structured_address_locality",
    "structured_address_region", "structured_price_range",
  ];
