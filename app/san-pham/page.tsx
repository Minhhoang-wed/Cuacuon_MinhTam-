...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<{ q?: string; category?: string }> }) {
  ...
  return <><PageHero eyebrow="Danh mục sản phẩm" title="Thiết bị phù hợp cho từng hệ cửa." description="Tra cứu theo danh mục hoặc tên sản phẩm. Thông số, mức giá và chính sách bảo hành được quản trị tập trung." image="https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=1600&q=82" />
